@extends('layouts.app', [
    ...
    'canonical' => url('/'),
    'ogType' => 'website',
    'ogImage' => asset('logo/zemtab-navy-red-icon-text-transparent.png'),
])
...
<main class="scroll-smooth overflow-hidden bg-zem-bg text-zem-cream" itemscope itemtype="https://schema.org/SoftwareApplication">
    ...
    <header class="fixed inset-x-0 top-0 z-40 border-b border-zem-border bg-white/90 shadow-sm backdrop-blur-xl">
        <div class="mx-auto flex max-w-7xl items-center justify-between px-5 py-4">
            <a href="/" class="inline-flex items-center" aria-label="ZemTab Home">
                <img src="{{ asset('logo/zemtab-navy-red-icon-text-transparent.png') }}" alt="ZemTab Logo - QR Menu, Table and Room Ordering System" class="h-12 w-auto">
            </a>
    ...
    <section class="relative px-5 pt-28" aria-label="Hero">
        <div class="absolute inset-0 bg-[radial-gradient(circle_at_18%_20%,rgba(238,61,74,.16),transparent_30%),radial-gradient(circle_at_82%_16%,rgba(255,255,255,.96),transparent_26%),linear-gradient(135deg,#F8FAFC_0%,#FFFFFF_44%,#EEF3F7_100%)]"></div>
        <div class="absolute inset-y-0 right-0 hidden w-1/2 bg-[linear-gradient(90deg,transparent,rgba(238,61,74,.08)_42%,rgba(5,31,66,.06))] lg:block"></div>
        ...
        <div class="relative mx-auto grid min-h-[88vh] max-w-7xl items-center gap-10 pb-20 lg:grid-cols-[1fr_.9fr]">
            <div class="max-w-3xl">
                ...
                <img src="{{ asset('logo/zemtab-navy-red-icon-text-transparent.png') }}" alt="ZemTab - Digital Menu, Table Ordering and Hotel Room Ordering" class="h-auto w-full max-w-xl">
            ...
            <div class="grid gap-8 md:grid-cols-4">
                <div class="md:col-span-2">
                    <a href="/" class="inline-flex items-center">
                        <img src="{{ asset('logo/zemtab-navy-red-text-transparent.png') }}" alt="ZemTab" class="h-8 w-auto">
                    </a>
...
<script type="application/ld+json">
{
    ...
    "image": "https://zemtab.com/logo/zemtab-navy-red-icon-text-transparent.png",
    "inLanguage": "en",
...
<script type="application/ld+json">
{
    ...
    "name": "ZemTab",
    "url": "https://zemtab.com",
    "logo": "https://zemtab.com/logo/zemtab-navy-red-icon-text-transparent.png",
